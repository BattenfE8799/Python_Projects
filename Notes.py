...
"""
def inputandwhileloopfunction():
    print("\t\n\nINPUTS\n\n")
    
    #using a flag to quit the program
...
def dictionary_userinput():
    #filing a dictinoary with userinput
    responses = {}
    polling_active = True
...
#passing an unknown amount of arguments
